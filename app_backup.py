...
from functions import (
    ...
    _api_get, fetch_customer_list, get_customer_completions,
    fetch_prices_from_api, fetch_sale_order,
    _get_or_create_sap_session, reset_sap_session,
    on_enter_btn, on_leave_btn,
    CHI_NHANH_MAP, CUSTOMER_GROUP_MAP,
)
...
def _init_load():
    ...
    def _do():
        ...
        def _done():
            ...
            lbl_status.config(text=f"  Đã tải {len(fn.ALL_CUSTOMERS)} khách hàng")
        root.after(0, _done)
